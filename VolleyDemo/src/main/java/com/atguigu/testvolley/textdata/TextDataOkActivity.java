package com.atguigu.testvolley.textdata;
 ...
 * 
 */
public class TextDataOkActivity extends Activity {

    protected static final String TAG = TextDataOkActivity.class.getSimpleName();
...
//        VolleyManager.getRequestQueue().add(request);
        VolleyManager.addRequest(request,"222");
...
//        VolleyManager.getRequestQueue().add(jsonObjectRequest);
        VolleyManager.addRequest(jsonObjectRequest,"333");
